...
serverUrl = os.getenv("MQTT_BROKER", "localhost")
serverPort = int(os.getenv("MQTT_PORT", "11883"))
myGroupId = os.getenv("SPB_GROUP_ID", "Sparkplug B Devices")
myNodeName = os.getenv("SPB_NODE_NAME", "Python Edge Node 1")
myDeviceName = os.getenv("SPB_DEVICE_NAME", "Emulated Device")
publishPeriod = int(os.getenv("PUBLISH_PERIOD", "5000"))
myUsername = os.getenv("MQTT_USERNAME", "admin")
myPassword = os.getenv("MQTT_PASSWORD", "changeme")
